...
macro_rules! impl_sync_bindings {
    ($bindings:ident) => {
        impl crate::$bindings::bindings::helios::system::sync::Host for StoreData {}

        impl crate::$bindings::bindings::helios::system::sync::HostRawMutex for StoreData {
        ...
        impl crate::$bindings::bindings::helios::system::sync::HostRawMutexWithStore
        ...
        impl crate::$bindings::bindings::helios::system::sync::HostRawMutexGuard for StoreData {
            async fn drop(
                &mut self,
                resource: Resource<HostedRawMutexGuard>,
            ) -> wasmtime::Result<()> {
                let _ = self.table.delete(resource)?;
                Ok(())
            }
        ...
        impl crate::$bindings::bindings::helios::system::sync::HostRawRwLock for StoreData {
        ...
        impl crate::$bindings::bindings::helios::system::sync::HostRawRwLockReadGuard
            for StoreData
        {
            async fn drop(
                &mut self,
                resource: Resource<HostedRawRwLockReadGuard>,
            ) -> wasmtime::Result<()> {
                let _ = self.table.delete(resource)?;
                Ok(())
            }
        ...
        impl crate::$bindings::bindings::helios::system::sync::HostRawRwLockWriteGuard
            for StoreData
        {
            async fn drop(
                &mut self,
        ...
        impl crate::$bindings::bindings::helios::system::sync::HostRawRwLockWithStore
            for HasSelf<StoreData>
        {
...
impl_sync_bindings!(program_bindings);
impl_sync_bindings!(debugger_bindings);
